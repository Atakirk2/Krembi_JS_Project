    ...
    for (let product of products) {
        html += `
                <tr>
                    ...
                    <td data-label="Image"><img id='img${product.id}' src='./assets/${product.isFavorite ? 'filled-star.png':'star.png'}'></td>
                </tr>
                `
                ||
                `
...
window.localStorage.setItem(`product${productCounter}`, JSON.stringify(product));
productCounter++;
